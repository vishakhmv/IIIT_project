...
def test_pipeline():
    ...
    csv_out_path = os.path.normpath(os.path.join(script_dir, '../../Results/fusion_accuracy_table.csv'))
    ...
    print(f"\n[SUCCESS] Fusion variance accuracy table successfully saved to: {csv_out_path}")
